...
Файл расположен: `docs/contracts/RENDER_CONTRACTS.md` (UTF-8 без BOM).
...
Если нужно, могу:
- добавить ссылку на этот документ в `docs/services/mapper/README.md` или `docs/architecture/agents/AGENT_MANIFEST.md`,
