...
| TP-06 | help | “Agent interpretation rules are defined in: docs/contracts/agent-interpretation.md” | STRONG GUIDANCE |
...
- TP-06 (help → docs/contracts/agent-interpretation.md): NOT-VERIFIABLE в рамках этого аудита (не проверялась полнота/актуальность этого файла относительно поведения).
...
- TA-09: “Agent interpretation rules are defined in: docs/contracts/agent-interpretation.md”.
